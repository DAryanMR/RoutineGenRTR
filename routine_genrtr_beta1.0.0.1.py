...
New: 
    - Course selection menu has course count
    - Default routine has red borders on overlapped courses (contains slight issues)
    - Added detailed model analysis on both default & updated routines
# Default__System__
"""
