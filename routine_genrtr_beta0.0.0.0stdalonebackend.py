...
This was the one where we came up with all the ideas, it contains a lot of bugs on different methods such as
finding alt section, updated routine overlap issues, etc! It is not recommended to use this one.
# Default__System__
"""
